...
def get_asset_path(filename):
    """Finds image files across local dev, installed package paths, and PyInstaller temp folders."""
    search_paths = [
    ...
    # Add PyInstaller's temporary extracted folder if running as an executable
    try:
...
class AppManager:
    ...
    def show_overlay(self):
        ...
        # Audio Trigger with explicit path
        if AUDIO_AVAILABLE:
